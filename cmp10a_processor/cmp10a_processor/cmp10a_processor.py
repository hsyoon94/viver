...
class IMUDriverNode(Node):
    ...
    def driver_loop(self, port_name):
        ...
        try:
            ...
            wt_imu = serial.Serial(port="/dev/ttyUSB0", baudrate=115200, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=0.5)
            wt_imu.write(b'SET ODR 200\r\n')
            if wt_imu.isOpen():
