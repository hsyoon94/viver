...
from sensor_msgs.msg import CompressedImage, PointCloud2, Image, CompressedImage
import threading
import queue
import time
...
class SingleTopicSender(Node):
    ...
    def image_callback(self, msg):
        try:
            ...
            self.send_queue.put(serialized_msg) # 디버그 로그 레벨을 INFO에서 DEBUG로 변경하여 로그 양을 줄임
